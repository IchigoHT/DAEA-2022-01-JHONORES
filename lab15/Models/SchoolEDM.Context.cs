...
namespace lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarPersonaID_Result> BuscarPersonaID(Nullable<int> personID)
        {
            var personIDParameter = personID.HasValue ?
                new ObjectParameter("PersonID", personID) :
                new ObjectParameter("PersonID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPersonaID_Result>("BuscarPersonaID", personIDParameter);
        }
        ...
        public virtual ObjectResult<ULogin_Result> ULogin(string usuario_nombre, string usuario_password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ULogin_Result>("ULogin", usuario_nombreParameter, usuario_passwordParameter);
        }
